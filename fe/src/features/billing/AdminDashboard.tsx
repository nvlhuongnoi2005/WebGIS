  ...
  return (
    <PageShell title={t("admin.title")}>
      ...
      {metrics && <>
        ...
        <Paper sx={{ p: { xs: 2, sm: 3 }, borderRadius: 3, border: "1px solid rgba(224, 0, 43, 0.17)", background: "linear-gradient(135deg, rgba(224, 0, 43, 0.12), rgba(169, 0, 32, 0.06) 52%, transparent)" }}>
        ...
        <Box>
          ...
          <TableContainer component={Paper} sx={{ borderRadius: 3, overflow: "hidden", border: "1px solid rgba(224, 0, 43, 0.15)" }}>
            <Table size="small" aria-label={t("admin.billingDetails")}>
              <TableHead sx={{ background: "linear-gradient(90deg, rgba(224, 0, 43, 0.14), rgba(169, 0, 32, 0.07))" }}><TableRow><TableCell>{t("admin.account")}</TableCell><TableCell>{t("billing.plan")}</TableCell><TableCell>{t("billing.monthlyUsage")}</TableCell><TableCell>{t("billing.period")}</TableCell></TableRow></TableHead>
              <TableBody>
...
const BAR_COLORS = ["#e0002b", "#c90027", "#a90020", "#ec3154", "#820018", "#d91a3f"];
