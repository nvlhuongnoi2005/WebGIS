  ...
  return (
    ...
    >
      <Stack
        ...
        spacing={2.5}
        sx={{ height: "100%", minHeight: 0, maxWidth: 1440, mx: "auto" }}
      >
        <Paper
          component="nav"
          ...
          sx={{
            ...
            position: { md: "sticky" },
            top: { md: 24 },
            border: "1px solid rgba(224, 0, 43, 0.15)",
          }}
        >
          <Stack
            direction="row"
            spacing={1.25}
            sx={{ alignItems: "center", justifyContent: "space-between", px: 1, py: 1.25 }}
          >
            <Stack direction="row" spacing={1.25} sx={{ alignItems: "center" }}>
              ...
              <Box>
                <Typography sx={{ fontWeight: 800 }}>{t("admin.title")}</Typography>
          ...
          <List disablePadding sx={{ py: 1 }}>
            {navigation.map((item) => {
              ...
              const destination = pathFor(item.id);
              return (
                <ListItemButton
                  key={item.id}
                  component="a"
          ...
          <Button
            ...
            sx={{ mt: 1.25, justifyContent: "flex-start" }}
          >
            {t("billing.backToMap")}
          </Button>
        </Paper>
